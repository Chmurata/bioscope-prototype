...
export default function PremiumChip({ onClick }) {
  return (
    <motion.button
      whileTap={{ scale: 0.95 }}
      onClick={onClick}
      className="relative overflow-hidden inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 cursor-pointer bg-black/20 backdrop-blur-md ring-1 ring-amber-300/30 shadow-[0_2px_10px_rgba(0,0,0,0.4)]"
    >
      {/* Shine sweep */}
      <motion.span
